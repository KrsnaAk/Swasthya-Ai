        ...
        <div className="pt-8 border-t border-white/5 space-y-8">
          <div className="p-6 rounded-2xl bg-destructive/5 border border-destructive/10">
            <p className="text-xs text-muted-foreground leading-relaxed text-center italic">
              ...
              <strong>Medical Disclaimer:</strong> This platform provides first-level triage guidance only and does NOT diagnose diseases or provide medical treatment. Always consult a qualified medical professional for any health concerns. In case of emergency, contact local emergency services immediately (108/102).
            </p>
          </div>
