    ...
    <section className="py-24 bg-card/20">
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {cases.map((c, i) => (
            <div key={i} className="flex gap-6 p-6 rounded-2xl bg-card/60 backdrop-blur-xl border border-border hover:bg-card/80 transition-colors group">
              <div className="h-14 w-14 shrink-0 rounded-xl bg-primary/10 flex items-center justify-center text-primary group-hover:bg-primary/20 transition-colors">
