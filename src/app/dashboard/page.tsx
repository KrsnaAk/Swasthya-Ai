          ...
          <div className="relative p-8 md:p-12 flex flex-col md:flex-row justify-between items-center gap-8">
            <div className="space-y-4 max-w-xl">
              <h1 className="text-3xl md:text-4xl font-headline font-bold text-foreground">
                Your Health, <span className="text-primary">Intelligently Navigated.</span>
              </h1>
              <p className="text-muted-foreground text-lg">
                Use our AI triage tool to analyze symptoms or find the nearest healthcare facility in seconds.
              </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <Card className="hover:border-primary/50 transition-all hover:shadow-lg group">
            ...
            <CardContent>
              <div className="h-32 rounded-lg bg-muted flex items-center justify-center border border-dashed border-border mb-4">
                <span className="text-xs text-muted-foreground">ABHA Integration Placeholder</span>
              </div>
              <Button variant="link" className="p-0 text-primary h-auto group-hover:translate-x-1 transition-transform">
                Link Records <ArrowRight className="ml-1 h-4 w-4" />
              </Button>
            </CardContent>
          </Card>
          ...
          <Card className="hover:border-primary/50 transition-all hover:shadow-lg group">
            <CardHeader>
              ...
              <CardDescription>Personalized tips and routines to stay healthy.</CardDescription>
            </CardHeader>
            <CardContent>
              {preventiveImage && (
            ...
            {[1, 2].map((i) => (
              <div key={i} className="flex items-center justify-between p-4 rounded-xl bg-card border border-border hover:border-primary/30 transition-colors">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <p className="font-medium">Mild Fever and Cough</p>
                    <p className="text-xs text-muted-foreground">Oct {10 + i}, 2023 • AI Recommendation: Home Care</p>
                  </div>
                </div>
